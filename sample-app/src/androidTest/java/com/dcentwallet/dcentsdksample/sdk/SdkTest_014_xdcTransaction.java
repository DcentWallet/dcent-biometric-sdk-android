...
public class SdkTest_014_xdcTransaction {
    ...
    @Test
    public void Test_002_xdcTransaction() {
        initDongleConnect();
        ...
        try{
            ...
            EthereumTransanction xdcTransaction;
            xdcTransaction = new EthereumTransanction.Builder()
            ...
            String response;
            response = dcentSdkManager.getDcentManager().getEthereumSignedTransaction(CoinType.XDC, xdcTransaction);
    ...
    @Test
    public void Test_003_xrc20Transaction() {
        initDongleConnect();
        ...
        try{
            String keyPath = "m/44'/550'/0'/0/0";
            TokenTransaction xrc20transaction;
            String response;

            xrc20transaction = new TokenTransaction.Builder()
                    .keyPath(Bip44KeyPath.valueOf(keyPath))
                    .nonce("14")
                    .toAddr("0x63d0c67570092d15f59e23ecabcff0d6d8d2e46a")
            ...
            response = dcentSdkManager.getDcentManager().getTokenSignedTransaction(CoinType.XRC20, xrc20transaction);
