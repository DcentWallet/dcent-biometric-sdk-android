...
public class SdkTest_003_syncAccount {
    ...
    @Test
    public void Test_003_syncAccount_bitcoin() {
        initDongleConnect();
    ...
    @Test
    public void Test_004_syncAccount_coreum() {
        initDongleConnect();
        ...
        try{
            ...
            SyncAccount syncAccount = new SyncAccount(CoinType.COREUM.getCoinGroup(), CoinType.COREUM.name(), "coreum_1", "0 CORE", keyPath);

            boolean res = dcentSdkManager.getDcentManager().syncAccount(syncAccount);
            /*Account account = new Account(CoinType.COREUM.getCoinGroup(), CoinType.COREUM.name(), "coreum_1", keyPath);
            boolean res = dcentSdkManager.getDcentManager().deleteDeviceAccount(account);*/
            assertTrue(res);
        }catch (DcentException dex){
            LOG.d("DcentException Code : " + Integer.toHexString(dex.get_err_code()).toUpperCase());
            fail();
