...
public class SdkTest_021_polkadotTransaction {
    ...
    @Test
    public void Test_002_polkadotTransaction() {
        initDongleConnect();
        ...
        try{
            ...
            response = dcentSdkManager.getDcentManager().getPolkadotSignedTransaction(CoinType.POLKADOT, polkadotTransaction);
