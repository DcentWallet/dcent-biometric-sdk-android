...
public class SdkTest_004_getAccountInfo {
    ...
    @Test
    public void Test_002_syncAccount_etheruem() {
        initDongleConnect();
        ...
        try{
            ...
            boolean res = dcentSdkManager.getDcentManager().syncAccount(syncAccount);
            assertTrue(res);
    ...
    @Test
    public void Test_003_getAccountInfo() {
        initDongleConnect();
        ...
        try{
            List<Account> accountList = dcentSdkManager.getDcentManager().getAccountInfo();
            ...
            for ( int i=0 ; i<accountList.size() ; i++ ) {
                ...
                if ( account.getCoinGroup().equalsIgnoreCase(CoinType.ETHEREUM.getCoinGroup())
                && account.getCoinName().equalsIgnoreCase(CoinType.ETHEREUM.name())
                && account.getLabel().equals("ethereum_1")
                && account.getReceivingAddressPath().equals(keyPath)) {
                    result = true;
                }
            }
            assertTrue(result);
